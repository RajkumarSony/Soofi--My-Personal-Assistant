...
"color: #1CA4E0;")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.labelTitle.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p><span style=\" font-weight:600; color:#1ca4e0;\">Soofi :</span><span style=\" font-weight:600; color:#9b9bff;\"/><span style=\" font-weight:600;\"> Personal Assistant</span></p></body></html>", None))
        self.labelPercentage.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p>0<span style=\" font-size:16pt; font-weight:600;\">%</span></p></body></html>", None))
        self.labelLoadingInfo.setText(QCoreApplication.translate("SplashScreen", u"loading...", None))
        self.labelCredits.setText(QCoreApplication.translate("SplashScreen", u"By :  Raj Kumar Sony", None))
    # retranslateUi
